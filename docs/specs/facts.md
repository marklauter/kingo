---
title: facts
summary: "A fact is one edge in the authorization graph: a subjectset joined to a subject. The subject is a subject id, a subjectset, or an object-set."
tags: [spec, graphs]
created: 2026-07-24
status: evolving
cites:
...
⟨subject⟩        ::= ⟨subject id⟩ | ⟨subjectset⟩ | ⟨object-set⟩
⟨object-set⟩     ::= ⟨resource⟩ '#' '...'
