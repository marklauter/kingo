---
title: Architecture
summary: "Kingo organizes as hexagonal with a DDD core: Kingo holds the domain (Domains and Facts), Kingo.Documents is the domain-document codec, .Json/.Yaml are wire-converter packs; no ports project until a genuine port family appears."
...
- [[realign-serialization-projects-around-their-real-consumers]] — `Kingo.Serialization` dissolved 2026-07-14; domain-document public-surface rework landed 2026-07-15: `DomainParser.Parse` + `domain.Print()`; the interim wrapper-document idea was dropped — no wrapper type needed.
