...
Facts and theories are separately writable artifacts that reference each other. Drift is a stored fact naming a namespace or relation the theory no longer defines. It has exactly two producers, and the Write service, as sole writer of both artifacts ([[grouping-the-apis-into-services]]), closes both:
