...
- [x] [[implement-contains-and-expand]]: condition 2 inverted, factset shapes and conditions 5–6 restated in case vocabulary, third case added to Naming, blocked-by edge added (2026-07-21).
...
- [x] Rule the `this`-expansion question — condition 9, folded into [[implement-contains-and-expand]] (2026-07-21).
...
- [x] Live docs swept for `Subject`-as-class references: [[ubiquitous-language]] (mapping row, case signatures, value-object list), [[implement-contains-and-expand]] (Contains signature, F9, leaf matching, condition 9, Decision seats), [[subject]] glossary (member shapes) (2026-07-21).
