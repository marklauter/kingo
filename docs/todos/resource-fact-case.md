...
summary: "Ruled 2026-07-21: `...` is not a relation. The exactly-specified tupleset member `folder:y#...` is the resource itself, carried by a third Fact case — Fact.ResourceFact, resource-only — and RelationName loses the Nothing sentinel. The three tupleset member shapes become the three Fact cases."
