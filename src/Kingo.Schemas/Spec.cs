...
/// invariants. The root of the config tree: it owns its namespaces, so it is what supplies their qualification and nothing
/// beneath it carries a qualified path ([[split-identities-at-ownership-boundaries]]).
/// </summary>
public sealed record Spec
{
    ...
    /// case-normalized by <see cref="NamespaceName"/>). <paramref name="name"/> arrives already valid — <see cref="SpecName.Parse"/> owns its grammar.
    /// </summary>
