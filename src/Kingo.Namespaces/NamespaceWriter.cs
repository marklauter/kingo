...
public sealed class NamespaceWriter(DocumentWriter<Key, Key> writer)
{
    ...
    private Either<Error, Unit> Insert(Document<Key, Key, SubjectSetRewrite> document, CancellationToken cancellationToken) =>
