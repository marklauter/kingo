...
/// <summary>
/// The result of an Expand evaluation. The full subject-set rewrite tree materialized for a <see cref="Kingo.Facts.SubjectSet"/>,
/// where Contains yields a short-circuiting boolean verdict (<see cref="Decision"/>). Expected to carry the
/// <see cref="Kingo.Facts.SubjectSet"/> asked about, the materialized rewrite tree, the snapshot pin, the domain version, and the
