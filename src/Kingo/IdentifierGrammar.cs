...
/// <summary>
/// The character rules and delimiters the identifier grammar is built from.
/// <para>
...
/// name is the rewrite grammar's, enforced by the theory document parser, not a character rule here. The one qualified path, <see cref="NamespacePath"/>, is two
