...
/// <see cref="Parse"/> normalizes to lowercase, the canonical form. The grammar is name-only, so <c>...</c> — the <c>#...</c> marker of the
/// <c>Fact.ResourceFact</c> member production, fact-grammar punctuation rather
/// than a relationship concept — fails to parse here.
/// </summary>
