...
/// <summary>
/// A named relationship and the rewrite that computes its effective subject set. Theory-side: this is the definition inside a <see cref="Namespace"/>, not the
...
/// <see cref="Theory"/>, so containment already says which relationship this is. A qualified path held here would be a second source of truth that could disagree
