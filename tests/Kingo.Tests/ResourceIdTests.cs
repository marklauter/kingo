...
public sealed class ResourceIdTests
{
    ...
    {
        var s = Assert.IsType<Result<ResourceId>.Success>(ResourceId.Parse(input));
    ...
    public void Parse_NullEmptyOrWhitespace_ReturnsEmptyValidationFailure(string? input)
    {
        ...
        var f = Assert.IsType<Result<ResourceId>.Failure>(ResourceId.Parse(input!));
    ...
    {
        var id = ResourceId.Unchecked("a:b#c@d");
    ...
    {
        var a = ResourceId.Unchecked("readme.md");
        var b = ResourceId.Unchecked("readme.md");
    ...
    {
        var a = ResourceId.Unchecked("readme.md");
        var b = ResourceId.Unchecked("license.txt");
    ...
    {
        var upper = ResourceId.Unchecked("A");
        var lower = ResourceId.Unchecked("a");
    ...
    {
        var id = ResourceId.Unchecked("readme.md");
