...
/// layer today: an adapter defines no exception types, because parse failures at the trust boundary are <c>Result</c> values and
...
/// <c>IDocumentSerializer</c> port; its replacement convention is pending.
/// </summary>
